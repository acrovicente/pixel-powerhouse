...
export function WhatsAppFab() {
  return (
    <a
      ...
      className="group fixed bottom-5 right-4 z-50 inline-flex items-center gap-3 rounded-full border border-primary/40 px-5 py-4 text-sm font-bold text-primary-foreground shadow-[0_14px_44px_-12px_var(--glow-strong)] transition-transform duration-300 hover:-translate-y-1 md:bottom-8 md:right-8"
